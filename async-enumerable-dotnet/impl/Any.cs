...
namespace async_enumerable_dotnet.impl
{
    internal sealed class Any<TSource> : IAsyncEnumerable<bool>
    {
        ...
        {
            return new AnyEnumerator(_source.GetAsyncEnumerator(cancellationToken), _predicate);
        }
    ...
    internal sealed class AnyTask<TSource> : IAsyncEnumerable<bool>
    {
        ...
        public IAsyncEnumerator<bool> GetAsyncEnumerator(CancellationToken cancellationToken)
        {
            return new AnyTaskEnumerator(_source.GetAsyncEnumerator(cancellationToken), _predicate);
        }
